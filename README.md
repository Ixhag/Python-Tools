...
If it shows a version number, you're ready. Open the tool you want below and continue with Step 2.
...
### 2.1 Download it
1. On this repo's GitHub page, click the **Code** button, then **Download ZIP** or https://u2l.ai/4Xcypz.
2. Unzip it and move the **`AI_Solver`** folder into your **Downloads** folder.
...
### From now on
You only need steps **2.4** and **2.6** each time you want to use it: go to the folder, then run it.
